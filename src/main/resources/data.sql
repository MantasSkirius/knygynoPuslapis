...
Rasa Drazdauskienė' WHERE id = 20;
UPDATE knygos SET aprasymas = 'Ketvirtoji vieno žymiausių šiuolaikinių lietuvių dramaturgų Mariaus Ivaškevičiaus pjesė „Madagaskaras“ gerai pažįstama ne tik skaitytojams, bet ir Lietuvos bei užsienio žiūrovams – iš Vilniaus mažojo teatro spektaklio, jau spėjusio tapti klasika.
                               ...
                               2-oji knygos „Madagaskaras“ laida.' WHERE id = 21;
UPDATE knygos SET aprasymas = 'Undinės Radzevičiūtės romanas „Žuvys ir drakonai" 2015 m. buvo įvertintas Europos sąjungos literatūros premija ir Lietuvių PEN centro išrinktas viena geriausių dešimtmečio knygų.
                               ...
                               Ši knyga – apie daugelį dalykų. Apie XVIII amžiaus europiečio svajonę pakeisti „tvarką" visame pasaulyje, net ir Kinijoje. Apie XVIII amžiaus prancūzų meilę kiniškiems dalykams ir viso „Senojo pasaulio" neapykantą prancūzams. Apie didėjančią Rytų ir Vakarų „difuziją". Apie šiuolaikinį žmogų, norintį pabėgti į nebeegzistuojančią Kiniją. Ir apie Rytus, kurie visada su mumis, nesvarbu, į kurią pusę žiūrėtume.' WHERE id = 22;
UPDATE knygos SET aprasymas = 'Poezija, proza, drama – savaimingos Gintaro Grajausko literatūrinės kūrybos sritys. Pasitelkdamas naujosios dramaturgijos priemones, rašytojo intuiciją ir humorą, G. Grajauskas  modernizuoja asmenybės ir lietuviškojo identiteto temas, skirtingų Lietuvos istorijos tarpsnių aktualijas.' WHERE id = 23;
UPDATE knygos SET aprasymas = 'Kęstutis Šapoka – ypatingo braižo ir ypač savito požiūrio rašytojas, radęs gerbėjų tarp konceptualesnės, intelektualesnės literatūros skaitytojų. Galima sakyti, kad jau patentuota yra šapokiška ironija ir šapokiškas šiuolaikinis socialinis realizmas.
...
UPDATE knygos SET aprasymas = 'Pasmerktame mieste pavojingiausia likti gyvam.
                               ...
                               Soboro durų angoje, galva kone remdamasi į staktą, stovėjo figūra, trimis galvomis aukštesnė už aukščiausią žmogų. Jos kūną slėpė ilgas juodas rūbas su plačiu gobtuvu, iš po jo žalia liepsna žybčiojo akys. Rankose figūra laikė plačius kirvius. „Ne, – staiga suvokė Sidabras, – tai kirviais baigiasi jos rankos!“' WHERE id = 25;
UPDATE knygos SET aprasymas = 'JAV gyvenančio poeto, vertėjo, literatūrologo eilėraščių ir vertimų rinktinė. Originalioji kūryba suskirstyta į keturis skyrius ("Veidrodis", "Kalbos ženklas", "Achilo skydas", "Tankėjanti šviesa"), jos pagrindu imamas išeivijoj išleistas eilėraščių rinkinys "98 eilėraščiai" (1977), o eilėraščių vertimai daugiausia atrinkti iš knygos "Balsai" (1979).' WHERE id = 26;
UPDATE knygos SET aprasymas = 'Tai devynių novelių rinkinys. Daugumos pagrindinis veikėjas – jaunuolis, nedidelio miestelio gyventojas, kartais – senukas, kartais – berniukas. Veikėjai dažniausiai labai jautrūs, dirglūs, nepritampantys prie aplinkybių, konfliktuojantys. Iš tų konfliktų išsirutulioja tragiškos kolizijos, sukečiančios skaitytoją. Prie to nemažai prisideda autoriaus sugebėjimas kalbėti provincialų kalba, autentiškai atkurti situacijas, taikliomis detalėmis atskleisti veikėjų charakterius, įlieti jaudinančių emocijų.' WHERE id = 27;
UPDATE knygos SET aprasymas = '
Aprašymas
...
' WHERE id = 28;
UPDATE knygos SET aprasymas = 'Pirmoji Jurgos Ivanauskaitės knyga „Pakalnučių metai“ (1985) – kultinis devintojo dešimtmečio alternatyvaus jaunimo tekstas, sudrumstęs ramius literatūros vandenis, ir iki šiol nepranoktas debiutas.

                               Šiomis novelėmis pradėjusi savo literatūros kelią, šiandien Jurga Ivanauskaitė – tarp skaitomiausių Europos rašytojų.' WHERE id = 29;
UPDATE knygos SET aprasymas = 'Romaną „Jauno žmogaus memuarai“  sudaro keturiolika laiškų, mirusio jauno žmogaus Leono Cipario rašomų iš anapus savo mokytojui ir draugui Tomui Kelertui. Leonas mėgina išsiaiškinti, kokios jėgos  įstūmė mus ten, kur esame, kaip jos formuoja tautą ir asmenybę.

                               Autoriaus personažas nebeišsitenka trimatėje erdvėje, todėl jo regimas blogis atsiskleidžia ne vien kaip etinis ar empirinis dydis, bet kaip metafizinė galia, nuolatos keičianti veidą, kurianti vis naujas struktūras, kurias atpažinti dar nereiškia – įveikti.' WHERE id = 30;
UPDATE knygos SET aprasymas = '„Silva Rerum“ – pirmasis žinomos žurnalistės, menotyrininkės, dr. Kristinos Sabaliauskaitės romanas.
                               ...
                               Užvertę šios knygos paskutinį puslapį jūs visiškai kitomis akimis žvelgsite į Žemaitijos girias, Vilniaus gatves ir nekaltai čirškiančius žvirblius. O galbūt net pradėsite kišenėje prietaringai nešiotis mažytį veidrodėlį – dėl visa pikta…' WHERE id = 1;
UPDATE knygos SET aprasymas = '„Vilniaus pokeris“ drąsiai ir atvirai tyrinėjami skaudūs Lietuvos istorijos bei lietuviškos dvasios dalykai. Autentiški įvykiai čia pinasi su neįtikimais, tarpais pasakojimas perauga į visišką fantasmagoriją, padiktuotą įaudrintos personažų psichikos. Tokiu rafinuotu būdu autorius stengiasi pavaizduoti Vilnių kaip ištisą pasaulį, realus Vilnius čia pasirodo kaip miestas vaiduoklis, miestas sapnas. Tą pačią tragišką istoriją keturi personažai pasakoja kiekvienas kitaip, vidiniuose monologuose skiriasi ne tik įvykių interpretacija – netgi patys įvykiai kiekviename pasakojime skirtingi, neretai prieštaringi ar išvis nesuderinami.
...
UPDATE knygos SET aprasymas = 'Jurgio Kunčino (1947–2002) romanas „Tūla“ priskiriamas prie ryškiausių lietuvių literatūros kūrinių, pasirodžiusių per du pastaruosius dešimtmečius. Fatališka meilė, Vilniaus gatveles užgulusi sovietmečio pilkuma, nerimo ir liūdesio slegiamas inteligentiškas jaunuolis – iš tokių vaizdų susiklostė geriausias J. Kunčino romanas. Pirmas leidimas pasirodė 1993 m. ir tais pačiais metais pelnė Rašytojų sąjungos premiją.
                               ...
                               ***
                               ...
                               Valentinas Sventickas' WHERE id = 3;
UPDATE knygos SET aprasymas = 'Balys Sruoga (1896-1947) - lietuvių literatūros klasikas. Be jo neįmanoma įsivaizduoti XX a. pirmosios pusės Lietuvos kultūrinio gyvenimo. Rašytojo atsiminimų knyga Dievų miškas vertinama kaip vienas originaliausių Europos memuaristikos kūrinių apie nacių koncentracijos stovyklas. Pirmą kartą atsiminimai išleisti 1957 m., autoriui jau mirus. 2005 m. režisierius Algimantas Puipa kūrinio motyvais pastatė kino filmą.

                               Ši knyga parengta pagal Lietuvos rašytojų sąjungos leidyklos 2005 m. leidimą. Kūrinio tekstas nekupiūruotas. Leidime palikta asmenvardžių ir vietovardžių rašyba su šiokiais tokiais netikslumais, kurių būta pirmame kūrinio rankraštyje.' WHERE id = 4;
UPDATE knygos SET aprasymas = '„Altorių šešėly“ – svarbiausias lietuvių literatūros klasiko Vinco Mykolaičio-Putino kūrinys. Šis psichologinis romanas ypač svarbus XX a. ketvirtojo dešimtmečio literatūros kontekste, nes puikiai atskleidžia filosofinį pagrindinio veikėjo santykį su gyvenamuoju laiku. Altorių šešėly pradėjo naują kelią lietuvių romano istorijoje ir iki šiol tebelaikomas geriausiu psichologiniu romanu lietuvių literatūroje.

                               Vincas Mykolaitis-Putinas (1893–1967) – poetas, prozininkas, dramaturgas, literatūros tyrinėtojas, vienas iškiliausių XX a. lietuvių kultūros veikėjų.' WHERE id = 5;
UPDATE knygos SET aprasymas = '„Savo romanuose aš visuomet bandau būti atvira, sąžininga ir nuoširdi. Mėginu savo skaitytojams parodyti, kad nebijotų nepažįstamų savo sielos gelmių ir kad jie netgi turėtų susidurti su tamsiausiais sielos užkampiais. Šis susidūrimas su žmogiškosios būties šešėliais ne visada malonus, tačiau, mano galva, absoliučiai būtinas kiekvienam individui. Šio tikslo aš visada siekiu kiekvienoje savo knygoje – ne tik „Raganoje ir lietuje“.“ – Iš J. Ivanauskaitės interviu dtv leidyklai
                               ...
                               ***
                               ...
                               „Per trumpą laiką romanas „Ragana ir lietus“, išleistas 1993 m., padarė Jurgą Ivanauskaitę garsiausia Lietuvos rašytoja...“ – Frankfurter Rundschau

                               „1961 m. gimusios J. Ivanauskaitės kūryba [...] yra naujos laisvės, kuriai pasiryžusi jauna lietuvių literatūra, pavyzdys. Ji kaip joks kitas autorius ar jokia kita autorė nutolsta nuo lietuviškos realybės, net kai ši jos romanuose yra susijusi su dabartimi.“ – Frankfurter Allgemeine

                               „J. Ivanauskaitė su savo „Ragana ir lietumi“ įėjo į pasaulinę literatūrą. – Kommune

                               „J. Ivanauskaitė patraukia savo pasakojimo stiliumi, kuria stiprių moterų paveikslus, nemenkindama ir vyrų, kurie vaizduojami kaip mylimieji, su savo silpnybėmis ir stiprybėmis, didingi ir griaunantys – labai žmogiški Dievo žmonės su žmogiškais troškimais.“ – Freitag 42

                               „J. Ivanauskaitės romaną „Ragana ir lietus“ buvo leidžiama pardavinėti tik sekso prekių parduotuvėse (tai padarė romaną bestseleriu).“ – Guardian Books Review

                               „J. Ivanauskaitės herojai – jauni menininkai, ieškantys gyvenimo prasmės ir trokštantys pakeisti visuomenę.“ – Frankfurter Allgemeine' WHERE id = 6;
UPDATE knygos SET aprasymas = 'Lietuvių rašytojo romane per pagrindinio personažo piemenuko pasaulėžiūra atskleidžiama socialinė neteisybė, išnaudojimas buržuaziniame kaime, buožių moralinė degradacija, sukurta ryškių, tipizuotų kaimo žmonių charakterių, spalvingų buities vaizdų.' WHERE id = 7;
UPDATE knygos SET aprasymas = 'Antanas Garšva dirba liftininku viename didžiausių Niujorko viešbučių. Jį slegia uniforma, bukinantis darbas, vienatvė, kamuoja egzistenciniai klausimai, kūrybinės kančios ir, regis, jis tuoj, tuoj išprotės.
...
UPDATE knygos SET aprasymas = 'Kontraversiškai vertinamas, audringai kritikuotas, netgi skandalingas... Tai Mariaus Ivaškevičiaus romanas „Žali", kuriame puikiai žinomi partizaninio karo dalyvių vardai atgyja ne tam, kad atspindėtų istorinę realybę, o tam, kad taptų naujo žaismingai, intriguojančiai ir drąsiai kuriamo postmodernaus literatūrinio paveikslo dalimi.
                               ...
                               „Po penkiolikos metų mes šį romaną nutarėme perleisti. Kaip suprantu, užaugo nauja karta, kuri tos knygos ieško ir būtų įdomu, kaip ši karta į visa tai pažiūrės."' WHERE id = 9;
UPDATE knygos SET aprasymas = 'Kaulinė dūdelė – tai trečioji savito poeto, dramaturgo, muzikanto Gintaro Grajausko eilėraščių knyga. 2000 m. ji apdovanota „Poezijos pavasario“ ir Ievos Simonaitytės premijomis.
...
UPDATE knygos SET aprasymas = '„Baden Badeno nebus“ – trečia Undinės Radzevičiūtės knyga po juodojo humoro ir absurdo miniromanų „Strekaza“ ir „Frankburgas“. Tai keistos istorijos apie žmones, kurių jūs nesutiksite gatvėje, o jeigu ir sutiksite, jie tų istorijų niekada jums nepapasakos...
                               ...
                               Undinės Radzevičiūtės istorijos – unikalios. Atitikmenų joms lietuvių literatūroje vargu ar rastume.– Kęstutis Navakas

                               Į mūsų šalies literatūrą žvelgiant kaip į gyvybingą Europos literatūros dalį, tarp Orientyrų serijos autorių užsieniečių kūrybos pirmąkart pateikiamas ir lietuvių autorės kūrinys.

                               „Orientyrai“ – tai knygų serija, kuri leidžia orientuotis šiuolaikinės literatūros pasaulyje ir atsakyti sau į klausimus, ar jį pažįstate, ar suprantante, kas ir kodėl jame vyksta ir ko iš jo tikėtis. Šie kūriniai atskleidžia šiuolaikinės prozos tendencijas ir vienaip ar kitaip veikia nūdienos literatūros procesą. „Orientyrai“ – tai ne sustingę obeliskai, bet veikiau vėjarodžiai, rodantys naujųjų kūrybinių vėjų kryptį.' WHERE id = 12;
UPDATE knygos SET aprasymas = 'Kartais, kai lieki visiškoje tamsoje, kai šviesa tave netikėtai apleidžia, akis užlieja keista aukso spalva, tarsi iš tamsos plūsteltų čia pat ore tvyrojusi ir tik tinkamos akimirkos laukusi iš kitos erdvės dimensijos trykštanti amalgama; nežinau, kuek trunka tokie akimirksniai, tačiau bet koks bandymas juos nupasakoti visuomet atrodo per ilgas ir dirbtinis...' WHERE id = 13;
UPDATE knygos SET aprasymas = 'Knyga „Vilko valanda“ yra atsakymų virtinė į klausimus, kas būtų buvę, jeigu Universiteto alchemikų atradimas būtų aukštyn kojom apvertęs Europos gyvenimą, o Vilnius būtų ištrūkęs iš Rusijos imperijos gniaužtų ir praėjusio amžiaus pradžioje tapęs Laisvuoju Miestu – progreso, mokslo ir mistikos centru.
                               ...
                               Valandų valandos praleistos archyvuose vartant anglų, rusų ir lietuvių kalba parašytus metraščius bei senas autoriaus fantastinės literatūros pomėgis kviečia pasinerti į nutrūktgalvišką Lietuvos sostinę Vilnių, svarstant, koks jis galėjo būti, jeigu įvykiai būtų susiklostę visai kitaip.

                               „Vilko valanda“ prasideda nuo ekskurso į praeitį - 35 metus iki veiksmo pradžios, kai Rusiją valdė caras Aleksandras II ir po kurio ekonominių reformų Rusijai katastrofiškai trūko pinigų. Ją taip pat ėdė milžiniško masto korupcija, į kurią buvo įklimpę aukščiausi pareigūnai. Besikuriančio Aljanso architektams tokia ant finansinės prarajos atsidūrusios Rusijos būklė buvo neįtikėtinai naudinga. Beje, visi šios ištraukos veikėjai - istoriškai autentiškos asmenybės.' WHERE id = 14;
UPDATE knygos SET aprasymas = 'Šiauliai. Vieno vaikino istorija iškart po nepriklausomybės. Kožos ir treningai, meilė ir pinigai, laukinis kapitalizmas ir regbis. Juokas pro ašaras... i viskas – originals.
...
UPDATE knygos SET aprasymas = '„Dalia Grinkevičiūtė (1927–1987) yra parašiusi svarbiausius, geriausiai žinomus lietuviškosios tremties literatūros kūrinius. Tai memuariniai pasakojimai, pavadinti „Atsiminimais" ir „Lietuviai prie Laptevų jūros" (šios apybraižos tęsinys – „Gimtojoj Žemėj"). Jie labiausiai vertinami dėl tikroviškų tremties vaizdų, išraiškingo įvykių traktavimo, didžiulio pirmosios publikacijos (1988) atgarsio sąjūdiškoje Lietuvoje ir dėl to, kad parašyti talentingo žmogaus, ypatingos asmenybės. D. Grinkevičiūtės kūryba remiasi jos pačios patirtimis, jausmais ir apmąstymais. Grinkevičių šeima su keturiolikmete Dalia buvo ištremta 1941 m. birželio keturioliktąją ir didžiąją dalį laiko kentėjo prie Laptevų jūros. Daliai leista grįžti į Lietuvą 1956 m.
                               ...
                               Pasakojimas „Gimtojoj Žemėj", datuojamas „po 1979 m.", vaizduoja iš tremties grįžusios D. Grinkevičiūtės sunkias patirtis susovietintoje Lietuvoje – „antrąjį Sibirą", – Valentinas Sventickas.' WHERE id = 16;
UPDATE knygos SET aprasymas = 'Nacionalinės premijos laureato R. Granausko apysakoje „Gyvenimas po klevu“ per vienos šeimos žlugimo istoriją skausmingai atsisveikinama su senuoju lietuvišku kaimu. Knyga sudrebino visuomenę savo beviltiškumu. Tada tai buvo nauja ir neleistina.

                               Kaimo žmogaus akimis parodoma niekuo nedangstoma gyvenimo tiesa. Apysakos herojė, vieniša senoji Kairienė, atrodo tokia tikra, lyg būtų perkelta į kūrinį tiesiai iš pačios skaudžiausios to meto kaimo realybės. Su vaikų apleistais senais tėvais, nesibaigiančiu girtuokliavimu, jaunimo dvasiniu skurdu ir kitom sovietinėm piktžaizdėm.' WHERE id = 17;
UPDATE knygos SET aprasymas = 'Lietuvių literatūros klasiko Jono Biliūno apsakymai ir apysaka.

                               Kūriniuose daugiausia keliamos etinės bei psichologinės problemos, jų neatsiejant nuo konkretaus socialinio pagrindo, subtiliai reiškiama humanistinė pasaulėjauta.' WHERE id = 18;
UPDATE knygos SET aprasymas = 'Antanas Vienuolis (tikroji pavardė Žukauskas) – Lietuvos farmacininkas, rašytojas prozininkas, dramaturgas, muziejininkas, visuomenininkas. Puikių legendų, romanų, apysakų, apsakymų, atsiminimų ir dramų autorius. Rašytojas savo kūryboje pasiekė didelio meistriškumo, vaizdavimo ir stiliaus raiškumo.' WHERE id = 19;